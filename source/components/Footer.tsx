        ...
        <footer className="bg-gray-100 grow" aria-labelledby="footer-heading">
            ...
            <div className="mx-auto max-w-7xl px-6 pb-8 pt-6 lg:px-8">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div className="mt-6">
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
                            <div>
                                <h3 className="mt-6 text-sm font-semibold leading-6 text-gray-900">Highlights</h3>
                            ...
                            <div>
                                <h3 className="mt-6 text-sm font-semibold leading-6 text-gray-900">Bronnen</h3>
                                <ul role="list" className="mt-3 space-y-4">
                            ...
                            <div>
                                <h3 className="mt-6 text-sm font-semibold leading-6 text-gray-900">Contact</h3>
                                <ul role="list" className="mt-3 space-y-4">
                ...
                <div className="mt-12 border-t border-gray-900/10 pt-8">
                    <p className="text-xs leading-5 text-gray-500">&copy; {new Date().getFullYear()} nuDeventer.nl</p>
                </div>
            </div>
        </footer>
    )
