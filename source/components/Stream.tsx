...
export default function Component() {
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div>
        <div className='relative bg-black aspect-video overflow-hidden rounded-t-lg'>
        ...
        <div className='bg-blue-600 flex rounded-b-lg'>
          <button className='ml-auto p-3 transition-all rounded-br-lg hover:bg-blue-900' onClick={() => player.current.enterFullscreen()}>
