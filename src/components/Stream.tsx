...
import assetMapGear from '@/assets/icons/mapgears.webp'
            ...
            <div className='mb-[1.125rem]'>
                <div className='-z-10 relative bg-primary aspect-video overflow-hidden rounded-lg'>
                    <MediaPlayer className='w-full h-full'
                        ...
                        autoplay
                        muted
                        onPlay={() => setTimeout(() => setIsLoading(false), 250)}
                    >
                        <MediaProvider />
                    </MediaPlayer>

                    <div className={classNames(
                        'absolute top-0 bg-primary h-full w-full',
                        isLoading ? 'block' : 'hidden'
                    )}>
                        <div className='absolute flex flex-col items-center gap-8 w-full top-1/2 -translate-y-1/2'>
                ...
                <div className='z-10 px-4 -mt-[3.75rem] w-full flex justify-end'>
                    ...
                    <Link href="https://mapgear.nl" target="_blank" className='bg-black p-2 m-1 transition-all hover:m-0 hover:p-3 hover:invert rounded'>
                        <Image src={assetMapGear} alt="MapGear" className='w-5 h-5' />
                    </Link>
                </div>
            </div>
        </div>
